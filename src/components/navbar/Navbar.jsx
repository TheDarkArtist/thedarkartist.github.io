...
const Navbar = ({handleSidebar}) => {
  return (
    <div className="h-12 lg:h-16 flex justify-between items-center fixed px-2 bg-gradient-to-br from-black via-red-950 to-black shadow-b shadow-zinc-900 shadow-md w-full z-30">
