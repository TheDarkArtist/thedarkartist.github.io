...
const sbar = ({ handleSidebar }) => {
  ...
  return (
    <>
      ...
      <div id='sidebar' className=' min-h-[100%] bg-green-950 w-0  transition-all duration-100 ease-in-out overflow-hidden fixed top-0 right-0 z-40 flex flex-col justify-top align-bottom shadow-l shadow-lg shadow-neutral-700 '>
        ...
        <ul className="flex flex-col justify-start p-2">
          ...
          <li className="flex items-center h-8 px-1 py-2 rounded-sm hover:bg-[#3a383a56] cursor-pointer">
